...
// Preparing and executing the queries with parameterized queries to prevent SQL injection
...
while ($stmt->fetch()) {
  ...
  $cuser = htmlspecialchars($cuser, ENT_QUOTES, 'UTF-8');
  $csuggestion = htmlspecialchars($csuggestion, ENT_QUOTES, 'UTF-8');
